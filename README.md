...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pypiserver-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15203&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pypiserver-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pypiserver` can be installed with:

```
conda install pypiserver
```

It is possible to list all of the versions of `pypiserver` available on your platform with:
